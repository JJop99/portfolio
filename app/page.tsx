...
const PROJECTS = [
  {
    ...
    description:
      "React single-page app built during a 3-month internship at Mumble S.R.L. Analyses website performance through the Google PageSpeed Insights API, with test history, Core Web Vitals visualisation, and secure authentication.",
  ...
  },
  {
    title: "luca_jop",
    description:
      "Next.js thesis project comparing client-side and server-side rendering patterns. Built to benchmark performance differences and support academic research on modern web rendering strategies.",
    tags: ["Next.js", "JavaScript", "SASS", "SSR", "CSR"],
  ...
  },
  {
    ...
    description:
      "Full-stack TypeScript app for tracking and splitting shared apartment expenses. Live demo available on Vercel.",
  ...
  },
  {
    title: "lucajop-react",
    description:
      "React rebuild of a personal website — a migration from a static version to a fully component-driven architecture.",
  ...
  return (
    <section id="projects" className="py-28 max-w-6xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {PROJECTS.map((p) => (
          <div key={p.title} className={`card rounded-2xl p-7 flex flex-col gap-4 relative overflow-hidden ${p.featured ? "md:col-span-1" : ""}`}>
            {p.label && (
            ...
            <h3 className="text-xl font-bold text-white pr-24">{p.title}</h3>
