  ...
  return (
    <section id="projects" className="py-28 max-w-6xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {PROJECTS.map((p) => (
          <div key={p.title} className="card rounded-2xl p-7 flex flex-col gap-4 relative overflow-hidden group">
            {p.label && (
            ...
            <div className="flex gap-4 pt-1 items-center">
              <Link
                ...
                className="flex items-center gap-1.5 text-sm text-teal-400 hover:text-teal-300 transition-colors font-semibold"
              >
                View details
